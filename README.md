...
| No. | 이름 | 담당 영역 |
| :---: | :---: | :--- |
| 1 | 이찬영 | **공연 탐색 · AI · Redis 대기열 · 전체 통합**<br>D01 홈, D02 검색 결과, D04 공연 상세, X01 AI 추천·FAQ, Q01 대기열 |
| 2 | 남수아 | **회원 · 회차 선택 · 예매내역**<br>M01 로그인, M02 회원가입, B01 회차 선택, M04 마이페이지·예매내역 |
| 3 | 강채은 | **좌석 · 주문 · 모의 결제 · 예약 확정**<br>B02 좌석 선택, B04 주문 확인, B05 모의 결제, B06 예매 완료 |
| 4 | 김민찬 | **관리자 운영 전체**<br>AD01 관리자 로그인, AD03 통합 대시보드, AD04 공연 등록·수정, AD06 공연장·좌석 관리, AD07 일정·회차 관리, AD08 좌석 재고·선점 현황, AD10 예매·주문 조회 |
